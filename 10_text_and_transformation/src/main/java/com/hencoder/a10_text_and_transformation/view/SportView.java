...
//        canvas.drawText(text, - bounds.left, - bounds.top + paint.getFontSpacing(), paint);
        ...
        String d = "readme";
        paint.setStyle(Paint.Style.FILL);
        paint.getTextBounds(d,0,d.length(),bounds);
        Log.e(TAG, "onDraw: getHeightCenter "+ getHeight()/2);
        Log.e(TAG, "onDraw: boundsCenter "+ (bounds.top+bounds.bottom)/2);
        Log.e(TAG, "onDraw: getHeightCenter+Bounds "+ (getHeight()/2-(bounds.top+bounds.bottom)/2));
        Log.e(TAG, "onDraw: left "+ bounds.left);
        Log.e(TAG, "onDraw: top "+ bounds.top);
        Log.e(TAG, "onDraw: right "+ bounds.right);
        Log.e(TAG, "onDraw: bottom "+ bounds.bottom);
        Log.e(TAG, "onDraw: "+ bounds.flattenToString());
        Log.e(TAG, "onDraw: "+ bounds.toShortString());
        canvas.drawText(d,getWidth()/2,getHeight()/2,paint);
        canvas.drawText(d,getWidth()/2,getHeight()/2-(bounds.top+bounds.bottom)/2,paint);
