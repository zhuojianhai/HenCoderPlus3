...
public class TestView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int left = getWidth()/2- 150;
        int top = getHeight()/2 -300;
        int right = getWidth()/2+150;
        ...
        pathMeasure = new PathMeasure(path,false);//计算path的长度
        float length = pathMeasure.getLength();//如果是圆，就是周长，如果是正方形
